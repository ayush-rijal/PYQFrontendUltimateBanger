...
const menuItems: MenuItem[] = [
  ...
  { title: "To-Do", url: "/dashboard/user/todo", icon: Calendar, category: "Main" },
  {
    title: "Lab",
    url: "/dashboard/user/lab",
    icon: Presentation,
    category: "Work",
    isLocked: true,
  },
  {
    ...
    url: "/dashboard/user/results",
    icon: ChartNoAxesCombined,
    category: "Work",
  },
  {
    title: "Collab",
    url: "/dashboard/user/whiteboard",
    icon: Users,
    category: "Work",
    isLocked: true,
  },
