...
//   const displayedQuestions = singleQuestionMode
//     ? questions.filter((q) => q.id === highlightedQuestionId)
//     : questions;
...
//                 exitSingleQuestionMode={exitSingleQuestionMode}
//                 allQuestions={allQuestions} // Pass allQuestions for badge calculation
//               />
//             </TabsContent>
//           </Tabs>
//         </div>
...
//   exitSingleQuestionMode: () => void;
//   allQuestions: Question[]; // Added to props for badge calculation
// }
...
//             const questionNumber = singleQuestionMode
...
export default function QuizPage() {
  ...
  const handleQuestionClick = (questionId: number) => {
    const questionIndex = allQuestions.findIndex((q) => q.id === questionId);
    // Calculate the page so the clicked question is included in the group of 5
  ...
  // const handleSubmitQuiz = () => {
  //   const quizId = uuidv4();
  //   const timeTaken = "15:30"; // Replace with actual timer logic
  //   router.push(
  //     `/quiz-app/category/${category0}/${category1}/${quizFile}/results/${quizId}?choices=${encodeURIComponent(
  //       JSON.stringify(selectedChoices)
  ...
  const handleSubmitQuiz = () => {
    const quizId = uuidv4();
    const timeTaken = "15:30"; // Replace with actual timer
    console.log("Submitting choices:", selectedChoices); // Debug
    router.push(
      `/quiz-app/category/${category0}/${category1}/${quizFile}/results/${quizId}?choices=${encodeURIComponent(
        JSON.stringify(selectedChoices)
      )}&time=${encodeURIComponent(timeTaken)}`
