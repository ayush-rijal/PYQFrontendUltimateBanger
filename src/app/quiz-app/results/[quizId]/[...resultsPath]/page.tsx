...
//   const categoryPath = resultsPath.slice(1, -1).join("/"); // e.g., "Medical/IOM"
...
//       router.push(`/quiz-app/category/${categoryPath}/${quizFile}`);
//     }
...
//             <BreadcrumbSeparator />
//             <BreadcrumbItem>
//               <BreadcrumbLink href={`/quiz-app/category/${categoryPath}`}>
//                 {/* {category0} */}
//                 {categoryPath}
//               </BreadcrumbLink>
//             </BreadcrumbItem>
...
//                 href={`/quiz-app/category/${categoryPath}`}
//               >
//                 {categoryPath}
//               </BreadcrumbLink>
//             </BreadcrumbItem>
          ...
          <BreadcrumbList>
            ...
            {categorySegments.map((segment, index) => (
              <React.Fragment key={index}>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink
                    href={`/quiz-app/category/${categorySegments.slice(0, index + 1).join("/")}`}
                  >
                    {segment}
                  </BreadcrumbLink>
                </BreadcrumbItem>
