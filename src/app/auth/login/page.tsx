...
export const metadata: Metadata = {
  ...
  description:
    "Log in to your PYQ account to access premium quizzes, track your progress, and continue your learning journey. Sign in now!",
  keywords: "login, sign in, PYQ, quiz app, online learning, account access",
  openGraph: {
    title: "Login to PYQ | Sign In to Your Quiz Account",
    description:
      "Sign in to PYQ to access your personalized quiz dashboard and premium content. Log in today!",
  ...
  twitter: {
    ...
    title: "Login to PYQ | Sign In to Your Quiz Account",
    description:
      "Access your PYQ account to enjoy premium quizzes and learning tools. Sign in now!",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Login to PYQ",
            description:
              "Sign in to your PYQ account to access premium quizzes and track your progress.",
