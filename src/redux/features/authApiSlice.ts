...
const authApiSlice = apiSlice.injectEndpoints({
	endpoints: builder => ({
		...
		socialAuthenticate: builder.mutation<
			...
			SocialAuthArgs
		>({
			query: ({ provider, state, code }) => ({   //since multiple parametes like provider,sstate,code so make them in object inside {}
				url: `/o/${provider}/?state=${encodeURIComponent(  //make urls safe by encodeuricomponent
					state
